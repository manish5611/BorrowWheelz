...
import LocationContext from "../extra_component/LocationContext";
import { AuthContext } from "../auth_components/AuthManager";
import globalBackendRoute from "../../config/Config";
import { FaTachometerAlt, FaUsers, FaCar, FaUserShield, FaSignOutAlt } from "react-icons/fa";
...
// If you need location context, ensure the correct import path or implement a fallback:
const useLocation = () => {
  // fallback dummy implementation if context is not available
  return {
