...
const AllRawMaterials = () => {
  ...
  const handleMaterialClick = async (id) => {
    try {
      const response = await axios.get(
        `${backendGlobalRoute}/api/raw-material/${id}`
      );
  ...
  const handleUpdateMaterial = async (e) => {
    ...
    try {
      await axios.put(
        `${backendGlobalRoute}/api/raw-material/${selectedMaterial._id}/ordered-history`,
        {
      ...
      await axios.put(
        `${backendGlobalRoute}/api/raw-material/${selectedMaterial._id}/reorder-history`,
        {
          quantity: updateData.quantity,
        }
      );
      ...
      await axios.put(
        `${backendGlobalRoute}/api/raw-material/${selectedMaterial._id}/refilling-history`,
        {
          quantity: updateData.quantity,
        }
      );
      ...
      await axios.put(
        `${backendGlobalRoute}/api/raw-material/${selectedMaterial._id}/status-history`,
        {
