    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-teal-50 text-[#1e1e2f] font-sans flex mt-[45px] mb-[-20px]">
      ...
      <div className="flex-1 p-8 space-y-6">
                          ...
                          <button
                            ...
                            onClick={async () => {
                              try {
                                ...
                                // Mark all cars in this order as unavailable
                                if (order.cars && order.cars.length > 0) {
                                  await Promise.all(
                                    order.cars.map((c) =>
                                      axios.put(
                                        `${globalBackendRoute}/api/update-car/${c.car?._id || c.car}`,
                                ...
                                const res = await axios.get(`${globalBackendRoute}/api/book/all-books`);
                                setBooks(res.data || []);
                                // Optionally refresh cars list
                                const carsRes = await axios.get(`${globalBackendRoute}/api/all-added-cars`);
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          {/* New Buttons */}
          <button
            className="flex flex-col items-center justify-center gap-2 bg-gradient-to-br from-pink-100 to-pink-50 rounded-xl p-4 shadow hover:scale-105 hover:shadow-lg transition font-semibold text-pink-700"
          ...
          <button
            className="flex flex-col items-center justify-center gap-2 bg-gradient-to-br from-purple-100 to-purple-50 rounded-xl p-4 shadow hover:scale-105 hover:shadow-lg transition font-semibold text-purple-700"
          ...
          <button
            className="flex flex-col items-center justify-center gap-2 bg-gradient-to-br from-orange-100 to-orange-50 rounded-xl p-4 shadow hover:scale-105 hover:shadow-lg transition font-semibold text-orange-700"
          ...
          <button
            className="flex flex-col items-center justify-center gap-2 bg-gradient-to-br from-gray-100 to-gray-50 rounded-xl p-4 shadow hover:scale-105 hover:shadow-lg transition font-semibold text-gray-700"
